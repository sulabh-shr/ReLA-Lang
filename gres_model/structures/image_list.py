...
from detectron2.structures import ImageList as DetImageList
from detectron2.layers.wrappers import move_device_like, shapes_to_tensor

from gres_model.utils.misc import get_pad_values


class ImageList(DetImageList):
    """
    Identical to ImageList from detectron2, except pad in the middle.
    """
    ...
    def from_tensors(
        ...
        if len(tensors) == 1:
            ...
            left_p, right_p, top_p, bottom_p = get_pad_values(max_size[-2:], image_size[:2])
            ...
            for i, img in enumerate(tensors):
                ...
                batched_imgs[i, ..., top_p:bottom_idx, left_p: right_idx].copy_(img)
